...
return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Form\\UserEmail' => function () {
    return ($this->privates['App\Form\UserEmail'] ?? $this->privates['App\Form\UserEmail'] = new \App\Form\UserEmail());
}, 'App\\Form\\UserMdp' => function () {
    return ($this->privates['App\Form\UserMdp'] ?? $this->privates['App\Form\UserMdp'] = new \App\Form\UserMdp());
}, 'App\\Form\\UserPseudo' => function () {
    return ($this->privates['App\Form\UserPseudo'] ?? $this->privates['App\Form\UserPseudo'] = new \App\Form\UserPseudo());
