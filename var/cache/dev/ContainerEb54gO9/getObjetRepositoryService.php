...
// Returns the private 'App\Repository\ObjetRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ObjetRepository.php';

return $this->privates['App\Repository\ObjetRepository'] = new \App\Repository\ObjetRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
