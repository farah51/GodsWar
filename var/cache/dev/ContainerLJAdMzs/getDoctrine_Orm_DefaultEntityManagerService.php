...
$a->setNamespace('sf_orm_default_53806867155f9b4ba5ddaf7a85ad874e3a96feb3caff10a514d2d914cbaec11c');

$b = new \Doctrine\Common\Cache\ArrayCache();
$b->setNamespace('sf_orm_default_53806867155f9b4ba5ddaf7a85ad874e3a96feb3caff10a514d2d914cbaec11c');

$c = new \Doctrine\Common\Cache\ArrayCache();
$c->setNamespace('sf_orm_default_53806867155f9b4ba5ddaf7a85ad874e3a96feb3caff10a514d2d914cbaec11c');
...
$e->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(array('App\\Repository\\ChatRepository' => function () {
    return ($this->privates['App\Repository\ChatRepository'] ?? $this->load(__DIR__.'/getChatRepositoryService.php'));
}, 'App\\Repository\\ObjectifRepository' => function () {
    return ($this->privates['App\Repository\ObjectifRepository'] ?? $this->load(__DIR__.'/getObjectifRepositoryService.php'));
}, 'App\\Repository\\ObjetRepository' => function () {
    return ($this->privates['App\Repository\ObjetRepository'] ?? $this->load(__DIR__.'/getObjetRepositoryService.php'));
}, 'App\\Repository\\PartieRepository' => function () {
    return ($this->privates['App\Repository\PartieRepository'] ?? $this->load(__DIR__.'/getPartieRepositoryService.php'));
